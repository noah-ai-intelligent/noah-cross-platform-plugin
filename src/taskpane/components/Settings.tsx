...
export function Toggle({
  ...
  return (
    <button
      ...
      className={`relative inline-flex h-5 w-9 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent/30 ${checked ? "bg-accent" : "bg-border-strong/60 hover:bg-border-strong"
        }`}
    >
      <span
