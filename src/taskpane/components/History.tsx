                  ...
                  {group.items.map((entry) => {
                    ...
                    return (
                      <button
                        ...
                        className={`group relative flex items-center justify-between w-full p-3 rounded-xl border text-left cursor-pointer transition-all duration-150 min-w-0 box-border ${isSelected
                      ...
                      >
                        ...
                        <div className="flex items-center gap-3 min-w-0 flex-1 pr-2">
                          <div
                            className={`w-8 h-8 rounded-lg flex items-center justify-center flex-none transition-all duration-150 ${isSelected
                          ...
                          <div className="flex flex-col min-w-0 flex-1 gap-0.5">
                            <div className="flex items-center gap-1.5 w-full min-w-0">
                              <span
                                className={`text-[13px] leading-tight truncate flex-1 min-w-0 transition-colors ${isSelected
